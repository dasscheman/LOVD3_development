...
To navigate around in an LOVD installation you can use the tabs on the top of the page. 
...
To get to the view transcript page you have to select a transcript in the view all transcript page or the view all transcript for a gene page. 
...
This view displays the unique variants for a gene. The number of times a variant is found is displayed in the field ``reported''.
...
Overview of all variants for a gene. Same variants are not grouped.
This menu item is not available when no gene is selected in the header.
...
To get to the view genomic variant page you have to select a variant in one of the vatiant list view. 
...
\section{Individuals}
When no gene is selected in the header, the default page of the individuals tab is the view individuals page.
...
\section{Diseases}
When a gene is selected in the header the default page of the tab is the view diseases with a filter for current gene. 
When no gene is selected all diseases in the database are displayed.
