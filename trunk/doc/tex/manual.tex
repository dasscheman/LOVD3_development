...
\chapter{View and search data}

Each tab does have a dropdown menu and the tab itself does have an default page to which you will go when you click on the tab.
The content of this dropdown menu depents on what your user level is.



\section{Search and sort}
All list views have a input field which can be used to search data.
...
LOVD will not only find genes starting with ``AAM'', but also containing ``AAM'', linke ``DAAM1'' and ``DAAM2''.
\begin{figure}[ht]
  \begin{shaded}
...
\begin{tabular}{>{\bfseries}p{2.3cm} p{2.3cm} p{10.7cm}}
  ...
  ="" & ="AM" & Exactly matches\\ \hline
  != & !=AM & Does not contain\\ \hline
  !="" & !="AM" & Does not exactly match\\ \hline
...
\newpage
\section{Genes}
\begin{wrapfigure}[13]{r}{8cm} % Only wrap for 3 lines
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{gene_menu.png}}\centering
  		\caption[]{
  			Gene menu. Create a new gene entry is only availabile for managers an up, see 
 			\hyperlink{sec:gene_create}{\nameref{sec:gene_create}} on how to.}
	\end{shaded}
\end{wrapfigure}
...
\textbf{View all genes}: Here you can see all the genes for this installation. 
You can click on a gene to go to the View gene homepage.

\textbf{View gene homepage}: Here you can see the details of a gene. See for more information: \hyperlink{sec:gene_homepage}{\nameref{sec:gene_homepage}}.
This menu item is not available when no gene is selected in the header.

\textbf{View graphs for a gene}: This displays the statistics of the variants within a gene. 
This menu item is not available when no gene is selected in the header.
...
\section{Transcripts}
\begin{wrapfigure}[11]{l}{8cm} % Only wrap for 3 lines
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{transcript_menu.png}}\centering
  		\caption[]{
  			Transcript menu. Create a new gene entry is only availabile for managers an up, see 
 			\hyperlink{sec:transcript_create}{\nameref{sec:transcript_create}} on how to.}
	\end{shaded}
\end{wrapfigure}
...
\textbf{View all transcripts} and \textbf{View all transcripts for a gene} are both views which list the transcripts. In both views you can click on a transcript to view the detail of this transcript on the View transcript page. 
The view all transcripts for a gene menu item is not available when no gene is selected in the header.

\textbf{View transcript}: To get to the view transcript page you have to select a transcript in  in the view all transcript page or the view all transcript for a gene page. 
On this page you can find details about the transcript and below the transcript details are all variant found on the transcript. 
You can click on the a variant in the variant list, this will bring you to the view genomic variant page.
...
\textbf{View all genomic variants}: This view displays all genomic variants in this LOVD installation.
You can click on the a variant, this will bring you to the view genomic variant page.

\textbf{View all variants affecting transcripts}: This view displays all variants in this LOVD installation found on a transcript. 
You can click on the a variant, this will bring you to the view genomic variant page.
...
\begin{wrapfigure}[18]{r}{8cm}
  \vspace{-25pt}
	\begin{shaded}
  		...
  		\caption[]{
  			Gene menu. Create a new gene entry is only availabile for managers an up, 
...
\textbf{View all variants for a gene}
This menu item is not available when no gene is selected in the header.

\textbf{Full data view for a gene}
This menu item is not available when no gene is selected in the header.

\textbf{View genomic variant}
...
\section{Individuals}
\begin{wrapfigure}[23]{r}{8cm} % Only wrap for 3 lines
  \vspace{-25pt}
	\begin{shaded}
