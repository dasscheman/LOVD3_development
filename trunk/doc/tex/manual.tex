...
\begin{wrapfigure}[23]{r}{8cm} % Only wrap for 3 lines
  \vspace{-25pt}
	...
	\end{shaded}
\end{wrapfigure}
The default page of the gene tab is the view all genes page when no gene is selected in the header. 
...
\textbf{View all transcripts}

\textbf{View all transcripts for a gene}

\textbf{View transcript}
...
\textbf{Full dat view for a gene}
