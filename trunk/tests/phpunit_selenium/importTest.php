...
class import_tests extends PHPUnit_Extensions_SeleniumTestCase
{
    ...
    public function testFalseUpdateImport()
    {
        ...
        $this->assertTrue((bool)preg_match('/^[\s\S]*Error \(Columns, line 9\): ID "Individual[\s\S]Age_of_death" already defined at line 8\.[\s\S]*$/',$this->getBodyText()));
