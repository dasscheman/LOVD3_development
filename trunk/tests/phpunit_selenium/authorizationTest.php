...
class authorization_tests extends PHPUnit_Extensions_SeleniumTestCase
{
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/submit/individual/00000001");
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/variants?create&reference=Transcript&geneid=IVD&target=0000000001");
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/phenotypes?create&target=00000001");
    ...
    {
        $this->open("/svn/LOVD3_development/trunktests/unit_tests/authorization.php");
