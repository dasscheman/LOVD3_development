...
class collaborator_tests extends PHPUnit_Extensions_SeleniumTestCase
{
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/users?create&no_orcid");
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/genes/GJB1?authorize");
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/variants/upload?create&target=0000000002");
        $this->assertEquals("To access this area, you need at least Manager clearance.", $this->getText("css=table[class=info]"));
    }
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/submit/screening/0000000002");
        $this->assertTrue((bool)preg_match('/^[\s\S]*\/trunk\/src\/submit\/screening\/0000000002$/',$this->getLocation()));
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/variants?create&reference=Transcript&geneid=GJB1");
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/variants?create&reference=Genome");
        $this->assertEquals("To access this area, you need at least Submitter (data owner) clearance.", $this->getText("css=table[class=info]"));
    }
    public function testAddSummaryVariantSeatlleseqFile()
    {
        $this->open("/svn/LOVD3_development/trunksrc/variants/upload?create&type=SeattleSeq");
        $this->assertEquals("To access this area, you need at least Submitter (data owner) clearance.", $this->getText("css=table[class=info]"));
    }
    public function testAddSummaryVariantVcfFile()
    {
        $this->open("/svn/LOVD3_development/trunksrc/variants/upload?create&type=VCF");
        $this->assertEquals("To access this area, you need at least Submitter (data owner) clearance.", $this->getText("css=table[class=info]"));
    }
    ...
    public function testPostFinishAddVariantOnlyDescribedOnGenomicLevelToCMTIndividual()
    {
        ...
        $this->click("css=input[type=\"submit\"]");
        $this->waitForPageToLoad("30000");
        $this->open("/svn/LOVD3_development/trunksrc/");
    ...
    {
        $this->open("/svn/LOVD3_development/trunksrc/genes/GJB1?delete");
        $this->assertEquals("To access this area, you need at least Manager clearance.", $this->getText("css=table[class=info]"));
    }
